...
import 'package:femaura/features/log_cycle/presentation/daily_symptoms_log/daily_symptoms_log_presenter.dart';
...
class DailySymptomsLogView extends ConsumerWidget {
  const DailySymptomsLogView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = Theme.of(context);
    final presenter = ref.read(dailySymptomsLogPresenterProvider.notifier);
